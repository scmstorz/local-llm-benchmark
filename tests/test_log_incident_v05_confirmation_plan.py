...
class LogIncidentV05ConfirmationPlanTests(unittest.TestCase):
    def setUp(self) -> None:
    ...
    def test_primary_and_transport_outcomes_are_separate(self) -> None:
        ...
        self.assertTrue(outcomes["supplemental_free_text_claim_review_required"])
        self.assertTrue(
            outcomes["deterministic_success_is_not_final_quality_acceptance"]
        )
