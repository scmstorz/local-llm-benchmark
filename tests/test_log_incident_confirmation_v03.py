...
from local_llm_benchmark.log_incident_confirmation_report_v03 import (
    build_log_incident_sweep_report,
)
from local_llm_benchmark.log_incident_confirmation_v03 import (
...
class LogIncidentV03ConfirmationControllerTests(unittest.TestCase):
    def setUp(self) -> None:
    ...
    def test_start_prepares_first_cell_without_inference(self) -> None:
        with tempfile.TemporaryDirectory(dir=self.results) as temporary:
            ...
            self.assertEqual(run["case"]["case_version"], "3.0.0")
    ...
    def test_mocked_live_boundary_checkpoints_without_real_ollama(self) -> None:
        with tempfile.TemporaryDirectory(dir=self.results) as temporary:
            ...
            with patch(
                "local_llm_benchmark.log_incident_confirmation_v03."
