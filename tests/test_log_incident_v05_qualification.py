...
QUALIFICATIONS = [
    Path(
        ...
        "log-incident-v0.5-offline-qualification.json"
    ),
    Path("tasks/agentic/track-b/mini-log-v0.5-qualification.json"),
    Path("tasks/agentic/track-b/pi-log-v0.5-qualification.json"),
]


class LogIncidentV05QualificationTests(unittest.TestCase):
    ...
    def test_harness_qualifications_share_protocol_and_outcome_boundary(self) -> None:
        ...
        self.assertEqual(mini["protocol_id"], "agentic-log-incident-v0.5")
        ...
        self.assertTrue(
            mini["comparison_boundary"][
                "supplemental_free_text_claim_review_required"
            ]
        )
        self.assertTrue(
            pi["comparison_boundary"][
                "supplemental_free_text_claim_review_required"
            ]
        )
