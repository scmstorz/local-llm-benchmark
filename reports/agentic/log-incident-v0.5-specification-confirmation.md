...
| --- | --- | ---: | ---: | ---: | ---: |
| Mini | `qwen3.8:27b-mlx` | 0/3 | 3/3 | 3/3 | 80.31 s |
| Pi 0.84.4 | `qwen3.8:27b-mlx` | 0/3 | 2/3 | 3/3 | 128.19 s |

## Per case

| Case | Semantic successes | Strict transport | Runtime-complete outcomes |
| --- | ---: | ---: | ---: |
| Checkout pool regression | 0/2 | 2/2 | 2/2 |
| Retry queue amplification | 0/2 | 2/2 | 2/2 |
| Clock skew partial recovery | 0/2 | 1/2 | 2/2 |
