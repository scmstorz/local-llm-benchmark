"""Build a public-safe report for the log-incident v0.5 confirmation."""
...
from .log_incident_confirmation_v05 import (
    HARNESS_IDS,
...
def build_log_incident_sweep_report(
    ...
    *,
    json_output: Path = Path(
        "reports/agentic/log-incident-v0.5-specification-confirmation.json"
    ),
    markdown_output: Path = Path(
        "reports/agentic/log-incident-v0.5-specification-confirmation.md"
    ),
) -> dict[str, Any]:
    ...
    by_system_model = [
        ...
        for deployment in [plan["deployment"]]
    ]
    by_case = [
        _aggregate(
    ...
    report = {
        ...
        "report_id": "log-incident-v0.5-specification-confirmation",
        "generated_at": utc_now(),
        "evidence_class": "excluded_specification_confirmation",
        "source": {
        ...
        "caveats": [
            ...
            "Historical v0.2, v0.3 and v0.4 attempts are not pooled with this corrected representation.",
...
def _markdown(report: dict[str, Any]) -> str:
    lines = [
        "# Agentic Log Incident v0.5 Specification Confirmation",
        "",
