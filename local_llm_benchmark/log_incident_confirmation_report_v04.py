"""Build a public-safe report for the log-incident v0.4 confirmation."""
...
from .log_incident_confirmation_v04 import (
    HARNESS_IDS,
...
def build_log_incident_sweep_report(
    ...
    *,
    json_output: Path = Path(
        "reports/agentic/log-incident-v0.4-specification-confirmation.json"
    ),
    markdown_output: Path = Path(
        "reports/agentic/log-incident-v0.4-specification-confirmation.md"
    ),
) -> dict[str, Any]:
    ...
    report = {
        ...
        "report_id": "log-incident-v0.4-specification-confirmation",
