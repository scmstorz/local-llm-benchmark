"""Build a public-safe report for the log-incident v0.3 confirmation."""
...
from .log_incident_confirmation_v03 import (
    HARNESS_IDS,
...
def build_log_incident_sweep_report(
    ...
    *,
    json_output: Path = Path(
        "reports/agentic/log-incident-v0.3-specification-confirmation.json"
    ),
    markdown_output: Path = Path(
        "reports/agentic/log-incident-v0.3-specification-confirmation.md"
    ),
) -> dict[str, Any]:
    ...
    report = {
        ...
        "report_id": "log-incident-v0.3-specification-confirmation",
...
def _markdown(report: dict[str, Any]) -> str:
    lines = [
        "# Agentic Log Incident v0.3 Specification Confirmation",
        "",
